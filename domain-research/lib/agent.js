...
- CORPORATE-HELD DOMAINS — name the humans, not the switchboard. When the operator turns out to be a LARGE corporate entity (publicly traded, Fortune-N, defensive/non-trading legacy brand, or registrar is a brand-protection shop like AuthenticWeb / MarkMonitor / CSC Corporate Domains / Safenames / Com Laude / Brandsight), the "primary contact" is NOT the corporate switchboard, a generic legal@/abuse@, or the registrar's privacy proxy. A user asking us "who do I reach" needs NAMED senior leaders in the function relevant to the inquiry. Enumerate 2–4 of them across the relevant functions — for a non-trading brand-protection domain that means corp dev / brand / legal (M&A or brand-protection / sale inquiries), IR / finance (purchase, divestiture), and IT / domain management (technical custody). Use rocketreach_search company-only AND with title hints — VP, Director, "Head of", "General Counsel", "Domain", "Brand", "Investor Relations", "Corporate Development" — and on the deep pass rocketreach_lookup every LinkedIn URL the searches return for email/phone. Surface those named individuals in the primary/secondary contact tiers (clearly tagged with their function) — they are the practical inbound route, not "call HQ".
